      ...
      "           v_texCoord = texture;                                                                                                     \n" 
                  //------------------     
      "           v_blurTexCoords[ 0] = v_texCoord + highp vec2(-3.0 * blurRadius, 0.0);                                                           \n"
      "           v_blurTexCoords[ 1] = v_texCoord + highp vec2(-2.0 * blurRadius, 0.0);                                                           \n"
      "           v_blurTexCoords[ 2] = v_texCoord + highp vec2(-1.0 * blurRadius, 0.0);                                                           \n"
      "           v_blurTexCoords[ 3] = v_texCoord + highp vec2( 0.0 * blurRadius, 0.0);                                                           \n"
      "           v_blurTexCoords[ 4] = v_texCoord + highp vec2( 1.0 * blurRadius, 0.0);                                                           \n"
      "           v_blurTexCoords[ 5] = v_texCoord + highp vec2( 2.0 * blurRadius, 0.0);                                                           \n"
      "           v_blurTexCoords[ 6] = v_texCoord + highp vec2( 3.0 * blurRadius, 0.0);                                                           \n" 
