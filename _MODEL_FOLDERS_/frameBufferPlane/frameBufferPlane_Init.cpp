...
//==============================================================================================================  
        ...
        "               highp vec4  hardShadow    = texture2D(Texture2, vTexCoord);                                                                        \n"

        "               highp float  shadowTemp   = ((hardShadow.r * -1.0) + 1.0) * 1.5;                                                                        \n"
        
        "               highp vec4  color         = texture2D(Texture1, vTexCoord);                                                                        \n"
        "               highp float shadowBlured  = texture2D(Texture1, vTexCoord).w;                                                                        \n"        
        

        "               gl_FragColor     = color * pow(shadowTemp, 1.0) * shadowBlured ;                                                                                       \n"
